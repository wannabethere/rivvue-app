package com.yatrix.activity.apps.social.config;
...
public class SocialConfig {
	...
	/**
	 * This has to be part of the mongo config.
	 * @return
	 */
	@Bean
	...
	public ProviderSignInController providerSignInController(RequestCache requestCache) {
		...
		providerSignInController.addSignInInterceptor(new FacebookSignInInterceptor(profileService, userAccountService));
