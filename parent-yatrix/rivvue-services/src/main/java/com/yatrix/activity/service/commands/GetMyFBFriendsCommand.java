...
public class GetMyFBFriendsCommand extends HystrixCommand<UserAccount>  {
	...
	public GetMyFBFriendsCommand(String authname,FacebookProfile profile, PagedList<FacebookProfile> friends) {
	...
	protected UserAccount run() throws Exception {
		...
		long lastUpdatedTimeStamp=loggedInUser.getUpdatedTimeStamp();
