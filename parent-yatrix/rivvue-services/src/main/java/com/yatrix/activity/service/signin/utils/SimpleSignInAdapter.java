  ...
  implements SignInAdapter
{
  ...
  @Inject
  public SimpleSignInAdapter(RequestCache requestCache, UserAdminService userAdminService) {
  ...
  public String signIn(String localUserId, Connection<?> connection, NativeWebRequest request) {
    ...
    SecurityContextHolder.getContext().setAuthentication(
      new UsernamePasswordAuthenticationToken(localUserId, account.getPassword(), account
        .getAuthorities()));
