...
@Service(value="userActivityReader")
public class UserActivityReader extends AbstractPagingItemReader<UserActivity> 
implements InitializingBean {
	...
	protected void doReadPage() {
		...
		results.addAll(userActivityCatalogService.findActivies(EVENT_STATUS.PENDING, (getPage() * getPageSize()), getPageSize()));
