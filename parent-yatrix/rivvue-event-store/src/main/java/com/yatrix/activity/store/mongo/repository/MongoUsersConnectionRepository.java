...
/**
 * {@link UsersConnectionRepository} that uses the JDBC API to persist connection data to a
 * relational database. The supporting schema is defined in JdbcMultiUserConnectionRepository.sql.
 */
public class MongoUsersConnectionRepository
  implements UsersConnectionRepository
{
  ...
  public List<String> findUserIdsWithConnection(Connection<?> connection) {
    ...
    List<String> localUserIds = mongoService.getUserIds(key.getProviderId(),
