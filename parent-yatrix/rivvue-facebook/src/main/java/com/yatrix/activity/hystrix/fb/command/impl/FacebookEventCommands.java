...
import com.yatrix.activity.hystrix.fb.command.impl.FacebookEventCommands;
...
public class FacebookEventCommands
  extends HystrixCommand<HystrixSocialResult>
  implements IFacebookCommand
{

  private static final Logger logger = LoggerFactory.getLogger(FacebookEventCommands.class);
