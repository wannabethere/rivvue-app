...
public class FacebookJoinEventCommand extends HystrixCommand<HystrixSocialResult>{
	...
	boolean addUser;
	public FacebookJoinEventCommand(UserEvent pUserActivity,Participant p,boolean addUser) {
		// Set to one minute
