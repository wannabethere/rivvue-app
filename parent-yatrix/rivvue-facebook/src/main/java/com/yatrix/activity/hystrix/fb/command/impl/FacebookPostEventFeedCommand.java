...
import com.yatrix.activity.hystrix.fb.command.impl.FacebookPostEventFeedCommand;
...
public class FacebookPostEventFeedCommand
extends HystrixCommand<HystrixSocialResult>
implements IFacebookPostEventFeedCommand
{
	
	private static final Logger logger = LoggerFactory.getLogger(FacebookPostEventFeedCommand.class);
	...
	public FacebookPostEventFeedCommand() {
		// Set to one minute
